#!/usr/bin/env python
"""
Test script for the PDF invoice parser using docling.
...
def main():
    """Main function to test the PDF parser with docling."""
    ...
    invoice_csv = "MyTest/output/docling_invoice_level.csv"
    item_csv = "MyTest/output/docling_item_level.csv"
